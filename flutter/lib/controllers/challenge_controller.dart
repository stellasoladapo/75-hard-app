...
import '../generated/challenge_definition.dart' as shared;
import '../models/challenge_state.dart';
import '../services/challenge_storage.dart';

typedef HabitDefinition = shared.HabitDefinition;

class ChallengeController extends ChangeNotifier {
  ChallengeController({required ChallengeStorage storage}) : _storage = storage;

  static const int challengeLength = shared.challengeLength;
  static const List<HabitDefinition> habits = shared.habits;
  ...
  String affirmationForToday() {
    ...
    return shared.dailyAffirmations[dayIndex % shared.dailyAffirmations.length];
  }
